...
class ResPartnerInherit(models.Model):
    ...
    def check_mobile_and_email(self):
        param_value_email = self.env['ir.config_parameter'].sudo().get_param('sttl_unique_contact_fields.unique_email')
        param_value_mobile = self.env['ir.config_parameter'].sudo().get_param('sttl_unique_contact_fields.unique_mobile')
